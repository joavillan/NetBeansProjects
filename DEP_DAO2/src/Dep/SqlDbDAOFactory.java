...
public class SqlDbDAOFactory extends DAOFactory {
    ...
    static String URLDB = "jdbc:mysql://jvillegas.salesianas.es/jvillegas_dep";
    static String USUARIO = "depusu";
    static String CLAVE = "Salesianas1**";

    public SqlDbDAOFactory() {
        DRIVER = "com.mysql.jdbc.Driver";
        URLDB = "jdbc:mysql://jvillegas.salesianas.es/jvillegas_dep";
    }
