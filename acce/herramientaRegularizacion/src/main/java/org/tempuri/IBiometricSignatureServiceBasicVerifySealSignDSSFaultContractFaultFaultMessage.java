...
public class IBiometricSignatureServiceBasicVerifySealSignDSSFaultContractFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public IBiometricSignatureServiceBasicVerifySealSignDSSFaultContractFaultFaultMessage(String message, SealSignDSSFaultContract faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public IBiometricSignatureServiceBasicVerifySealSignDSSFaultContractFaultFaultMessage(String message, SealSignDSSFaultContract faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
